...
<style>
    ...
    .info-card { background: var(--surface); border-radius: 24px; padding: 2.5rem; box-shadow: var(--shadow-md); border: 1px solid var(--border); }
    .info-card h2 { font-size: 1.25rem; font-weight: 800; color: var(--text); margin-bottom: 1.5rem; display: flex; align-items: center; gap: 12px; }
    .info-icon { width: 42px; height: 42px; background: rgba(var(--primary), 0.1); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--primary); flex-shrink: 0; }
    .info-prose { font-size: 0.95rem; line-height: 1.8; color: var(--text-muted); }
        ...
        <div class="content-grid">
            ...
            <div>
                <div class="info-card">
                    ...
                    @else
                    <div style="background:var(--surface-2);border:2px dashed var(--border);border-radius:16px;padding:3rem;text-align:center;">
                        <svg width="40" height="40" fill="none" stroke="var(--text-light)" stroke-width="1.5" viewBox="0 0 24 24" style="margin:0 auto 12px;"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        <p style="color:var(--text);font-size:0.9rem;font-weight:600;">Informasi lengkap akan segera ditambahkan.</p>
                        <p style="color:var(--text-muted);font-size:0.85rem;margin-top:6px;">Silakan langsung mengisi formulir pendaftaran.</p>
                    </div>
                    @endif
                </div>
            ...
            <div>
                ...
                {{-- Contact Card --}}
                <div style="background:var(--surface);border-radius:20px;padding:1.5rem;margin-top:1.5rem;border:1px solid var(--border);box-shadow:var(--shadow-sm);">
                    <div style="font-size:0.85rem;font-weight:800;color:var(--text);margin-bottom:12px;">Ada Pertanyaan?</div>
