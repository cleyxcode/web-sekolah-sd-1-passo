...
<section id="profil-guru" style="padding:80px 0;background:var(--bg);transition:background 0.3s;">
    <div class="container">
        ...
        <div style="text-align:center;margin-bottom:52px;">
            ...
            <h2 style="font-size:clamp(1.8rem,4vw,2.8rem);font-weight:900;color:var(--text);margin-bottom:14px;transition:color 0.3s;">
                Guru & Staff <span style="background:linear-gradient(135deg,#2563eb,#7c3aed);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">Profesional</span>
            </h2>
            <p style="font-size:1rem;color:var(--text-muted);max-width:520px;margin:0 auto;line-height:1.75;transition:color 0.3s;">
        ...
        <div id="guru-slideshow" style="position:relative;overflow:hidden;">
            ...
            {{-- Track --}}
            <div id="guru-track" style="display:flex;gap:24px;transition:transform 0.55s cubic-bezier(0.4,0,0.2,1);will-change:transform;">
                @foreach($profil_guru as $i => $guru)
                <div class="guru-card" style="flex:0 0 calc(33.333% - 16px);min-width:calc(33.333% - 16px);max-width:calc(33.333% - 16px);">
                    ...
                    onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='none';this.style.borderColor='var(--border)';">
                        ...
                        <div style="position:absolute;top:0;left:0;right:0;height:90px;background:linear-gradient(135deg,#dbeafe,#ede9fe);z-index:0;transition:background 0.3s;"></div>
                        [data-theme="dark"] .guru-deco { background: linear-gradient(135deg,rgba(37,99,235,0.15),rgba(124,58,237,0.15)); }
                        ...
                        <div style="position:relative;z-index:1;">
                            <h3 style="font-size:1rem;font-weight:800;color:var(--text);margin-bottom:6px;line-height:1.3;transition:color 0.3s;">
                                {{ $guru->nama }}
                            </h3>
                            ...
                            {{-- Divider --}}
                            <div style="height:1px;background:var(--border);margin:14px 0;transition:background 0.3s;"></div>

                            {{-- NIP --}}
                            @if($guru->nip)
                            <div style="display:flex;align-items:center;justify-content:center;gap:5px;font-size:0.72rem;color:var(--text-muted);font-weight:600;transition:color 0.3s;">
            ...
            <button id="guru-prev"
                ...
                <svg id="guru-prev-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="#475569" style="transition:stroke 0.2s;">
            ...
            <button id="guru-next"
                ...
                onmouseover="this.style.background='#2563eb';this.style.borderColor='#2563eb';"
                onmouseout="this.style.background='var(--surface)';this.style.borderColor='var(--border)';">
                <svg id="guru-next-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="#475569" style="transition:stroke 0.2s;">
...
@media (max-width: 640px) {
    ...
    #guru-prev, #guru-next { display: none !important; }
}
