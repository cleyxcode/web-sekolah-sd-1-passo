{{-- Hero Section --}}
<section class="section" style="background:var(--bg);overflow:hidden;position:relative;transition:background 0.3s;padding-top:7rem;">
    {{-- BG Blobs --}}
    ...
    <div class="container">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center;">
            ...
            <div class="fade-up" style="position:relative;z-index:1;">
                ...
                <h1 class="hero-title" style="font-size:clamp(2rem,5vw,3.5rem);font-weight:900;color:var(--text);line-height:1.1;margin-bottom:1.25rem;transition:color 0.3s;">
                ...
                {{-- Stats --}}
                <div class="hero-stats" style="display:flex;gap:2rem;margin-top:2.5rem;padding-top:2rem;border-top:1px solid var(--border);">
                    <div>
    ...
    <style>
        ...
        @media(max-width:480px) {
            ...
            .hero-stats { flex-wrap: wrap; gap: 1rem !important; }
        }
    </style>
</section>
