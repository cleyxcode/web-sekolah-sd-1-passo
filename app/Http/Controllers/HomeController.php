...
use App\Models\Pendaftaran;        // Model untuk mengambil data berita
use App\Models\ProfilSekolah; // Model untuk profil, visi, misi, dan sejarah
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Schema;

        // Model untuk foto-foto galeri
...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $pendaftaran = Pendaftaran::where('is_active', true)->latest()->first();
    ...
    public function pendaftaran()
    {
        ...
        if (! $pendaftaran->link_pendaftaran || ! filter_var($pendaftaran->link_pendaftaran, FILTER_VALIDATE_URL)) {
            return redirect()->route('home')->with('error', 'Link pendaftaran tidak valid.');
        }
